...
<div class="header">
					     ...
					     <ul>
                                               <li ><a href="index.jsp">Home</a></li>
                                                ...
                                                <li><a href="Register.jsp">Register</a></li>
                                                    <li  class="active"><a href="Reg_Provider.jsp">Provider Register</a></li>
 ...
 <div style="margin-left:350px;height: 200px;margin-top: 100px">
                        ...
                        <form name="form" action="pro_reg.jsp" method="post" onsubmit="return validateTime();">
                     
                            <label for="text1" style="color: white">Provider Username          : </label> <input id="text1" type="text" name="txt1" value="" /><br />  <br />
                            <label for="text2" style="color: white">Password     &nbsp;     :</label><input id="text2" type="password" name="txt2" value="" /><br />  <br />
                             <label for="text2" style="color: white">Server Name     &nbsp;     :</label><input id="text3" type="text" name="txt3" value="" />
                            <br />     <br />
