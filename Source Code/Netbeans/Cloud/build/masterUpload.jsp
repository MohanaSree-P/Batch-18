...
String name="image"+sb1.toString();
        ...
        out.println(saveFile);
               String strPath = patt+"Master_File"+"\\"+saveFile;
            ...
            fileOut.close();
        out.println(saveFile);
        String strPath3 = patt+"Hide_Files"+"\\"+saveFile;
         File ff11 = new File(strPath3);
            FileOutputStream fileOut11 = new FileOutputStream(ff11);
            fileOut11.write(data, 0, data.length);
            fileOut11.flush();
            fileOut11.close();
        out.println(saveFile);
       ...
       con = DriverManager.getConnection("jdbc:mysql://localhost:3306/resource","root","admin");
                    ...
                    String queryString = "insert into videohide values (?,?,?,?,?,?,?,?)";
...
st5.setInt(1,0);
  ...
  st5.setString(2, tsfile);                                                              
  st5.setString(3, "");
  st5.setString(4, "1");                                                              
    st5.setString(5, (String)session.getAttribute("usrid")); 
     st5.setString(6, text); 
     st5.setString(7, ""); 
     st5.setString(8, ""); 
   int s = st5.executeUpdate();   
   response.sendRedirect("datafile.jsp?id="+text+"&msg=Video Uploaded Successfully");
