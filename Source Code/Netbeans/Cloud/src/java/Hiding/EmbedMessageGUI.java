...
public class EmbedMessageGUI extends JFrame implements ActionListener, ItemListener
{
	...
	{
		super("Embedding message - Steganograph "+ CPT.VERSION+ "   ");
		...
		lblOutput= new MyJLabel("Master file", arialFont, Color.black, Color.lightGray);
	...
	public void actionPerformed(ActionEvent e)
	{
       ...
       for(int h=0;h<height/10;h++)
         for(int w=0;w<width/10;w++)
           ...
           raster.setSamples(w*10,h*10,10,10,0,fill);
            ...
            try {
                ...
                ImageIO.write(im, "JPG", new File(txtOutputFile.getText()));
            } catch (IOException ex) {
                Logger.getLogger(EmbedFileGUI.class.getName()).log(Level.SEVERE, null, ex);
            }}
		...
		if(source== btnGo)
		{
			...
			if(CPT.embedMessage(client.getMasterFile(), client.getOutputFile(), txtMessage.getText(), compression, password))
